...
<html lang="en">
  <head>
    ...
    <!-- Chart.js -->
    <script src="../vendor/genvendors/Chart.js/dist/Chart.min.js"></script>
    <!-- gauge.js -->
    <script src="../vendor/genvendors/gauge.js/dist/gauge.min.js"></script>
    <!-- bootstrap-progressbar -->
    ...
    <!-- Skycons -->
    <script src="../vendor/genvendors/skycons/skycons.js"></script>
    <!-- Flot -->
    <script src="../vendor/genvendors/Flot/jquery.flot.js"></script>
    <script src="../vendor/genvendors/Flot/jquery.flot.pie.js"></script>
    <script src="../vendor/genvendors/Flot/jquery.flot.time.js"></script>
    <script src="../vendor/genvendors/Flot/jquery.flot.stack.js"></script>
    <script src="../vendor/genvendors/Flot/jquery.flot.resize.js"></script>
    <!-- Flot plugins -->
    <script src="../vendor/genvendors/flot.orderbars/js/jquery.flot.orderBars.js"></script>
    <script src="../vendor/genvendors/flot-spline/js/jquery.flot.spline.min.js"></script>
    <script src="../vendor/genvendors/flot.curvedlines/curvedLines.js"></script>
    <!-- DateJS -->
    <script src="../vendor/genvendors/DateJS/build/date.js"></script>
    <!-- JQVMap -->
    <script src="../vendor/genvendors/jqvmap/dist/jquery.vmap.js"></script>
    <script src="../vendor/genvendors/jqvmap/dist/maps/jquery.vmap.world.js"></script>
    <script src="../vendor/genvendors/jqvmap/examples/js/jquery.vmap.sampledata.js"></script>
    <!-- bootstrap-daterangepicker -->
    <script src="../vendor/genvendors/moment/min/moment.min.js"></script>
    <script src="../vendor/genvendors/bootstrap-daterangepicker/daterangepicker.js"></script>
